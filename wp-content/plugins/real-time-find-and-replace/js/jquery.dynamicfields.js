function addFormField() {
  var id = parseInt(jQuery('#id').val(), 10) || 1;
  ...
  jQuery("#far_itemlist").append(
    "<li id='row" + id + "'>" +
      ...
      "<div style='float: left;'>" +
        ...
        "<div style='float: left;'>" +
          "<label for='farfind" + id + "'>Find:</label><br />" +
          "<textarea class='left' name='farfind[" + id + "]' id='farfind" + id + "'></textarea>" +
        "</div>" +

        "<div style='float: left;'>" +
          "<label for='farreplace" + id + "'>Replace:</label><br />" +
      ...
      "<div style='float: left;'>" +
        ...
        "<label class='side-label' for='farposttype" + id + "'>Post Type:</label>" +
        "<select disabled='disabled' name='farposttype[" + id + "]' id='farposttype" + id + "'><option value='any'>any</option></select>" + /* ← quitamos comilla extra */ 
        "<br />" +
        ...
        "<label class='side-label' for='farreferrer" + id + "'>Referrer:</label>" +
  ...
  id = id + 1;
  jQuery('#id').val(id);
  jQuery('html, body').animate({ scrollTop: jQuery("#row" + (id - 1)).offset().top }, 300);
}